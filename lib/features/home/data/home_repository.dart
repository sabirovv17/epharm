    ...
    Product(
      ...
      pkg: ProductPackage(
        background: LinearGradient(
          ...
          colors: [Color(0xFFF4F1ED), Color(0xFFF8E7DD)],
        ),
        label: 'NATROL',
    ...
    Product(
      ...
      pkg: ProductPackage(
        background: LinearGradient(
          ...
          colors: [Color(0xFFFBEADF), Color(0xFFEE9A6F)],
        ),
        label: 'VITRUM C',
        accent: Color(0xFFD86C3A),
      ),
      isNew: true,
    ),
    Product(
    ...
    Product(
      ...
      pkg: ProductPackage(
        background: LinearGradient(
          ...
          colors: [Color(0xFFFBEADF), Color(0xFFE78A5C)],
        ),
        label: 'HUGGIES',
        accent: Color(0xFFC95E33),
      ),
      contest: true,
    ),
  ];
