...
class ReconcileController(
    ...
    /**
     * Загрузка чека (фото и/или QR) от имени фармацевта. multipart: file? + qr? + pharmacistId.
     * Прогоняет OCR → матчинг с pending_bonus → определяет ветку (auto/manual/fraud).
     */
