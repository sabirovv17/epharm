...
enum class AdminRole {
    /** Полный системный доступ, включая роли и настройки обучения. */
    SYSTEM_ADMIN,

    /** Head of Trade Marketing / общий администратор HQ. */
    HQ_HEAD,

    /** Управляет программами, назначениями, событиями и результатами обучения. */
    TRAINING_MANAGER,

    /** Видит и администрирует обучение только в закреплённых регионах. */
    REGIONAL_MANAGER,

    /** Проводит офлайн-мероприятия и фиксирует посещаемость/результаты. */
    TRAINER,
