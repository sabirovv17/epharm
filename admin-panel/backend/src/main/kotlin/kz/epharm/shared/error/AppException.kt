...
enum class ErrorCode {
    ...
    OTP_RESEND_TOO_SOON,
    // SMS-провайдер недоступен/отклонил отправку — код не ушёл, OTP-строка откатана.
    SMS_SEND_FAILED,
    // Внешний провайдер принял SMS-запрос, но временно недоступен на этапе проверки кода.
